package com.problemfighter.pfspring.hl2c.controller;
...
@RestController
@RequestMapping("/api/v1/hl2c-person")
public class ApiV1Hl2cPersonController implements RestApiAction<Hl2cPersonMasterDTO, Hl2cPersonDetailDTO, Hl2cPersonUpdateDTO> {

    @Autowired
    private Hl2cPersonService personService;

    @RequestMapping(value = "/create", method = RequestMethod.POST)
    public MessageResponse create(@RequestBody RequestData<Hl2cPersonDetailDTO> data) {
        return personService.create(data);
    }

    @RequestMapping(value = "/bulk-create", method = RequestMethod.POST)
    public BulkResponse<Hl2cPersonDetailDTO> bulkCreate(@RequestBody RequestBulkData<Hl2cPersonDetailDTO> data) {
        return personService.bulkCreate(data);
    }

    @RequestMapping(value = "/list", method = RequestMethod.GET)
    public PageableResponse<Hl2cPersonMasterDTO> list(
    ...
    public PageableResponse<Hl2cPersonDetailDTO> detailList(
            @RequestParam(value = "page", defaultValue = "") Integer page,
            @RequestParam(value = "size", defaultValue = "") Integer size,
            @RequestParam(value = "sort", defaultValue = "") String sort,
            @RequestParam(value = "field", defaultValue = "") String field,
    ...
    public PageableResponse<Hl2cPersonMasterDTO>  trash(
            @RequestParam(value = "page", defaultValue = "") Integer page,
            @RequestParam(value = "size", defaultValue = "") Integer size,
            @RequestParam(value = "sort", defaultValue = "") String sort,
            @RequestParam(value = "field", defaultValue = "") String field,
    ...
    public DetailsResponse<Hl2cPersonDetailDTO> details(@PathVariable(name = "id") Long id) {
        return personService.details(id);
    }

    @RequestMapping(value = "/update", method = RequestMethod.PATCH)
    public MessageResponse update(@RequestBody RequestData<Hl2cPersonUpdateDTO> data) {
        return personService.update(data);
    }

    @RequestMapping(value = "/bulk-update", method = RequestMethod.PATCH)
    public BulkResponse<Hl2cPersonUpdateDTO> bulkUpdate(@RequestBody RequestBulkData<Hl2cPersonUpdateDTO> data) {
